...
TGA_data = pd.read_pickle("pickle_jar/TGA_data_good2.pkl") # weight loss data
...
y = dat['Mg-OH'] #change this to change your responce variable
...
#Warning writes file
# mod_stat_df.to_csv("output_data/23_3_27_Al-OH_180-325C_best_subset_OLR_and_C.csv")
...
#Warning writes file
# fig.savefig('output_data/23_3_27_Al-OH_180-325C_best_subset_linear_regression.svg', transparent=False, bbox_inches="tight")

#%% Gett details of best model

n = 1 #Change to be the index of model you want
